...
def killUnfinishedJobs(
    jediTaskID, code=None, verbose=False, srvID=None, useMailAsID=False
):
...
def setNumSlotsForWP(
    pandaQueueName, numSlots, gshare=None, resourceType=None, validPeriod=None
):
    """Set num slots for workload provisioning
